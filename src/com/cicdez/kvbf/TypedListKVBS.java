...
public class TypedListKVBS extends AbstractAccountedKVBF<List<IKVBF<?>>> {
    private int componentType;
    private List<IKVBF<?>> list;

    public TypedListKVBS(int componentType, List<IKVBF<?>> list) {
        this.componentType = componentType;
        this.list = list;
    }
    public TypedListKVBS(int componentType) {
        this(componentType, new ArrayList<>());
    }
    public TypedListKVBS() {
